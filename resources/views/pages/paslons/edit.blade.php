    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form method="POST" action="{{ route('paslon.update', $paslon) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_paslon') is-invalid @enderror" name="nama_paslon" value="{{ $paslon->nama_paslon }}">
                                @error('nama_paslon')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('no_urut') is-invalid @enderror" name="no_urut" value="{{ $paslon->no_urut }}">
                                @error('no_urut')
                                    <div class="invalid-feedback">{{ 'Masukkan Angka 1-12' }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
