...
class UpdateDesaDapil1Controller extends Controller
{
    ...
    public function updatetuntulow(Request $request)
    {
        // Mendapatkan pengguna yang terautentikasi
        $user = $request->user();
        ...
        $nm_caleg = $validatedData['nm_caleg'];
        $caleg = Ds1_Tuntulow::where('nm_caleg', $nm_caleg)->first();
        if (!$caleg) {
            return response()->json(['message' => 'Paslon Tidak Ditemukan'], 404);
        }
        $total_suara = array_sum(array_slice($validatedData, 1)); // Mengambil semua nilai tps_* untuk dijumlahkan
    ...
    public function updatetuntung(Request $request)
    {
        // Mendapatkan pengguna yang terautentikasi
        $user = $request->user();
        ...
        $nm_caleg = $validatedData['nm_caleg'];
        $caleg = Ds1_Tuntung::where('nm_caleg', $nm_caleg)->first();
        if (!$caleg) {
            return response()->json(['message' => 'Paslon Tidak Ditemukan'], 404);
        }
        $total_suara = array_sum(array_slice($validatedData, 1)); // Mengambil semua nilai tps_* untuk dijumlahkan
    ...
    public function updatetuntungtimur(Request $request)
    {
        // Mendapatkan pengguna yang terautentikasi
        $user = $request->user();
        ...
        $nm_caleg = $validatedData['nm_caleg'];
        $caleg = Ds1_Tuntungtimur::where('nm_caleg', $nm_caleg)->first();
        if (!$caleg) {
            return response()->json(['message' => 'Paslon Tidak Ditemukan'], 404);
        }
        $total_suara = array_sum(array_slice($validatedData, 1)); // Mengambil semua nilai tps_* untuk dijumlahkan
    ...
    public function updatetontulowutara(Request $request)
    {
        // Mendapatkan pengguna yang terautentikasi
        $user = $request->user();
        ...
        $nm_caleg = $validatedData['nm_caleg'];
        $caleg = Ds1_Tontulowutara::where('nm_caleg', $nm_caleg)->first();
        if (!$caleg) {
            return response()->json(['message' => 'Paslon Tidak Ditemukan'], 404);
        }
        $total_suara = array_sum(array_slice($validatedData, 1)); // Mengambil semua nilai tps_* untuk dijumlahkan
    ...
    public function updatebatutajam(Request $request)
    {
        // Mendapatkan pengguna yang terautentikasi
        $user = $request->user();
        ...
        $nm_caleg = $validatedData['nm_caleg'];
        $caleg = Ds1_Batutajam::where('nm_caleg', $nm_caleg)->first();
        if (!$caleg) {
            return response()->json(['message' => 'Paslon Tidak Ditemukan'], 404);
        }
        $total_suara = array_sum(array_slice($validatedData, 1)); // Mengambil semua nilai tps_* untuk dijumlahkan
    ...
    public function updatebuko(Request $request)
    {
        // Mendapatkan pengguna yang terautentikasi
        $user = $request->user();
        ...
        $nm_caleg = $validatedData['nm_caleg'];
        $caleg = Ds1_Buko::where('nm_caleg', $nm_caleg)->first();
        if (!$caleg) {
            return response()->json(['message' => 'Paslon Tidak Ditemukan'], 404);
        }
        $total_suara = array_sum(array_slice($validatedData, 1)); // Mengambil semua nilai tps_* untuk dijumlahkan
    ...
    public function updatebukoselatan(Request $request)
    {
        // Mendapatkan pengguna yang terautentikasi
        $user = $request->user();
        ...
        $nm_caleg = $validatedData['nm_caleg'];
        $caleg = Ds1_Bukoselatan::where('nm_caleg', $nm_caleg)->first();
        if (!$caleg) {
            return response()->json(['message' => 'Paslon Tidak Ditemukan'], 404);
        }
        $total_suara = array_sum(array_slice($validatedData, 1)); // Mengambil semua nilai tps_* untuk dijumlahkan
    ...
    public function updatebukoutara(Request $request)
    {
        // Mendapatkan pengguna yang terautentikasi
        $user = $request->user();
        ...
        $nm_caleg = $validatedData['nm_caleg'];
        $caleg = Ds1_Bukoutara::where('nm_caleg', $nm_caleg)->first();
        if (!$caleg) {
            return response()->json(['message' => 'Paslon Tidak Ditemukan'], 404);
        }
        $total_suara = array_sum(array_slice($validatedData, 1)); // Mengambil semua nilai tps_* untuk dijumlahkan
    ...
    public function updatebusato(Request $request)
    {
        // Mendapatkan pengguna yang terautentikasi
        $user = $request->user();
        ...
        $nm_caleg = $validatedData['nm_caleg'];
        $caleg = Ds1_Busato::where('nm_caleg', $nm_caleg)->first();
        if (!$caleg) {
            return response()->json(['message' => 'Paslon Tidak Ditemukan'], 404);
        }
        $total_suara = array_sum(array_slice($validatedData, 1)); // Mengambil semua nilai tps_* untuk dijumlahkan
